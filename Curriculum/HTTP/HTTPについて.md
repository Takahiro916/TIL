...
[![Image from Gyazo](https://i.gyazo.com/4937e078ada8c2840d108a7b599f09f5.png)](https://gyazo.com/4937e078ada8c2840d108a7b599f09f5)

### 【input要素】  
- 入力フィールドやボタンなどのパーツを作成するときに使用する。  
- 属性と入力型を組み合わせて使用する。  
<br/>

|属性|説明|
| --- | --- |
|type|所定の値を指定することで入力欄や送信ボタンを作成する|　　
|name|input要素の名前をしていする|
|value|input要素の値を指定する。テキスト入力欄では初期入力値。ボタンではボタン名を表す|
